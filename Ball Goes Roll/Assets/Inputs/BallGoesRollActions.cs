// GENERATED AUTOMATICALLY FROM 'Assets/Inputs/BallGoesRollActions.inputactions'
...
public class @BallGoesRollActions : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @BallGoesRollActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""BallGoesRollActions"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    public struct PlayerActions
    {
        ...
        public PlayerActions(@BallGoesRollActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @BallGoesRollActions m_Wrapper;
        public UIActions(@BallGoesRollActions wrapper) { m_Wrapper = wrapper; }
